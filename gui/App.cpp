...
namespace gui {
	...
	App::App(const MazeSimulator& maze_simulator, MazeDiscovery& maze_discovery, Mouse& mouse, Discover& discovery) :
		maze_simulator(maze_simulator), maze_discovery(maze_discovery), mouse(mouse), discovery(discovery)
	{
	}
